                ...
                <div class="scrollable-y-hover grow shrink-0 flex ps-2 lg:ps-5 pe-1 lg:pe-3" data-scrollable="true"
                    ...
                    <div class="menu flex flex-col grow gap-0.5" data-menu="true" data-menu-accordion-expand-all="false"
                        ...
                        <div class="menu-item pt-2.25 pb-px">
                            <span
                                class="menu-heading uppercase text-2sm font-medium text-gray-500 ps-[10px] pe-[10px]">
                                User
                            </span>
                        </div>
                        <div class="menu-item" data-menu-item-toggle="accordion" data-menu-item-trigger="click">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item flex-col-reverse" data-menu-item-toggle="accordion"
                                            ...
                                            <div class="menu-link border border-transparent grow cursor-pointer gap-[5px] ps-[10px] pe-[10px] py-[8px]"
                                                ...
                                                <span
                                                    class="menu-title text-2sm font-normal text-gray-600 dark:text-gray-500">
                        ...
                        <div class="menu-item" data-menu-item-toggle="accordion" data-menu-item-trigger="click">
                            ...
                            <div
                                ...
                                <div class="menu-item">
                                    <div class="menu-label border border-transparent items-center grow gap-[14px] pe-[10px] py-[8px]"
                                        href="#" tabindex="0">
                                        <span
                                            class="menu-bullet flex w-[6px] -start-[3px] rtl:start-0 relative before:absolute before:top-0 before:size-[6px] before:rounded-full rtl:before:translate-x-1/2 before:-translate-y-1/2 menu-item-active:before:bg-primary menu-item-hover:before:bg-primary">
                                        </span>
                    ...
                    <div class="flex items-stretch" id="mega_menu_container">
                        ...
                        <div class="flex items-stretch" data-reparent="true" data-reparent-mode="prepend|lg:prepend"
                            ...
                            <div class="hidden lg:flex lg:items-stretch" data-drawer="true"
                                ...
                                <!--Megamenu-->
                                <div class="menu flex-col lg:flex-row gap-5 lg:gap-7.5" data-menu="true"
                                    id="mega_menu">
                                    <!--Megamenu Item-->
                                    ...
                                    <div class="menu-item" data-menu-item-offset="-300px, 0"
                                        ...
                                        <div
                                            class="menu-dropdown flex-col lg:flex-row gap-0 w-full lg:max-w-[1240px]">
                                            <div
                            ...
                            <div class="dropdown-content light:border-gray-300 w-screen max-w-[450px]">
                                        ...
                                        <div class="flex items-end justify-end gap-3.5 px-5">
                                            <div class="flex flex-col gap-1.5">
                                                ...
                                                <div class="flex items-center justify-end relative">
                                                    ...
                                                    <i
                                                        class="ki-filled ki-double-check text-lg absolute text-success">
                                                    </i>
                                                </div>
                                            </div>
                                ...
                                <div class="mb-2.5">
                                    ...
                                    <div class="relative grow mx-5">
                                        ...
                                        <div
                                            class="flex items-center gap-2.5 absolute end-3 top-1/2 -translate-y-1/2">
                                ...
                                <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="menu-item" data-menu-item-offset="-50px, 0"
                                            ...
                                            data-menu-item-placement-rtl="right-start"
                                            data-menu-item-toggle="dropdown"
                                            data-menu-item-trigger="click|lg:hover">
                                            <div class="menu-link">
                                                <span class="menu-icon">
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="#">
                                                        ...
                                                        <span class="menu-badge" data-tooltip="true"
                                                            ...
                                                            <i
                                                                class="ki-filled ki-information-2 text-md text-gray-500">
                                                            </i>
                                        ...
                                        <div class="menu" data-menu="true">
                                            <div class="menu-item" data-menu-item-offset="0, 10px"
                                                ...
                                                <div class="menu-dropdown menu-default w-full max-w-[200px]"
                                                    ...
                                                    <div class="menu-item">
                                                        <a class="menu-link"
                                                            data-modal-toggle="#share_profile_modal" href="#">
                                                            <span class="menu-icon">
                                                                <i class="ki-filled ki-share">
                                                                </i>
                                                            </span>
