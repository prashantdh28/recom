...
export default {
    ...
    theme: {
        extend: {
            backgroundImage: {
                "auth-light": "url('../../public/assets/media/authbg.jpg')",
                "auth-dark": "url('../../public/assets/media/authbg-dark.jpg')",
            },
            base: {
                colors: {
                    gray: {
                ...
                boxShadows: {
                    light: {
                        ...
                        primary: "0px 4px 12px 0px rgba(83, 36, 255, 0.35)",
            ...
            fontFamily: {
                ...
                icon: ["FontAwesome", "system-ui", "sans-serif"],
            },
            colors: {
                gray: {
                    100: "var(--tw-gray-100)",
            ...
            components: {
                common: {
                    ...
                    borders: {
                        ...
                        dark: {
                            card: `1px solid ${
                                theme("base.colors.gray.dark")["100"]
                            }`,
                            table: `1px solid ${
                                theme("base.colors.gray.dark")["100"]
                            }`,
    ...
    plugins: [
        ...
        //   require('./resources/metronic/core/plugins/components/swel'),
    ],
};
